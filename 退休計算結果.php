...
exec("C:/Users/Alia/AppData/Local/Programs/Python/Python37/python.exe new_choose_consider_y_input.py 2>error.txt {$yyyy} {$need_pension} {$y_in_money} {$mode}",$out,$ret);
    ...
    <div class="container">
      ...
      <div class="row">
                            ...
                            <div class="col-lg-10">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title">投資金流模擬<?php //print_r($ret);print_r($out); ?></h4>
                                    ...
                                    <div class="chartjs-wrapper"><canvas id="chartjs-1" class="chartjs" width="undefined" height="undefined"></canvas>
                                        <script>new Chart(document.getElementById("chartjs-1"),
                                            ...
                                            [{"label":"資產總額","data": <?php echo "[ $his_total_money1 ]"; ?>,"fill":false,"borderColor":"rgb(75, 192, 192)","lineTension":0.1},
                                                        {"label":"累計投入本金","data": <?php echo "[ $in_money1 ]"; ?>,"fill":false,"borderColor":"rgb(255, 0, 0)","lineTension":0.1}]},
                                                        "options":{}});
                                        </script>
                                    </div>
