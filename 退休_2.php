...
// $_SESSION["totalAmt"] = $_POST["totalAmt"];
        ...
        $f = $_POST["in_per_year"];
        $e = $_POST["risk"];
        $sql = "INSERT INTO test_table3 (`age`, `retireAge`, `expectAge`, `expenses`, `in_per_year`, `risk`) VALUES ($a,$b,$c,$d,$f,$e)";
...
exec("C:/Users/Alia/AppData/Local/Programs/Python/Python37/python.exe choose.py 2>error.txt {$yyyy} {$need_pension} {$y_in_money} {$mode}",$out,$ret);
...
//計算歷史回測報酬率
// $his_y = count(explode(" ",$out[4]));
// $his_y=5;//決定要回溯幾年
// $his_m=$his_y*12;
if (strcmp( $_SESSION['ymd'] , '日' ) == 0){//歷史回測單位為日
  $his_d = $_SESSION['ymdnum'];
  $his_d+=1;
  $o0 = implode(",",$var);
  $o1 = implode(",",$weight);
  unset($out);
  exec("C:/Users/Alia/AppData/Local/Programs/Python/Python37/python.exe historical_day.py 2>error.txt {$o0} {$o1} {$his_d}",$out,$ret);
  $his_reward = explode(" ",$out[0]);//歷日報酬率
  $yy = explode(" ",$out[1]);//日期陣列

  $yy1 = implode(",",$yy);

  //累計投入金額陣列 歷史
  // if( strcmp( substr( $yy[0] ,-2) , '15' ) == 0 ){
  //   $in_money2 = array(0=>$y_in_money/12);
  // }
  // else {
  //   $in_money2 = array(0=>0);
  // }
  $in_money2 = array(0=>$y_in_money/12);
  for ( $i=1 ; $i<$his_d ; $i++ ){
    if( strcmp( substr( $yy[$i] ,-2) , substr( $yy[0] ,-2) ) == 0 ){
      $in_money2[$i] = $in_money2[$i-1] + $y_in_money/12;
    }
    else {
      $in_money2[$i] = $in_money2[$i-1];
    }
  ...
  //資產總額2陣列 歷史回測
  $his_total_money = array(0=>$in_money2[0]);
  //$total_money[1] = $in_money[1];
  for ( $i=1 ; $i<$his_d ; $i++ ){
      ...
      if( strcmp( substr( $yy[$i] ,-2) , substr( $yy[0] ,-2) ) == 0 ){
        $his_total_money[$i]+= $y_in_money/12;
      }
  ...
  if (strcmp( $_SESSION['ymd'] , '年' ) == 0){//歷史回測單位為年，轉為月
    $his_m = $_SESSION['ymdnum']*12;
  }
  elseif(strcmp( $_SESSION['ymd'] , '月' ) == 0){
    $his_m = $_SESSION['ymdnum'];
  }
  ...
  $o1 = implode(",",$weight);
  unset($out);
  exec("C:/Users/Alia/AppData/Local/Programs/Python/Python37/python.exe historical_2.py 2>error.txt {$o0} {$o1} {$his_m} {$y_in_money}",$out,$ret);
...
// unset($out);
// exec("C:/Users/Alia/AppData/Local/Programs/Python/Python37/python.exe historical_analysis.py 2>error.txt {$o0} {$o1} {$y_in_money}",$out,$ret);
...
// unset($out);
// exec("C:/Users/Alia/AppData/Local/Programs/Python/Python37/python.exe historical_event2.py 2>error.txt {$o0} {$o1} {$y_in_money}",$out,$ret);
// $his_event = explode(" ",$out[0]);

unset($out);
exec("C:/Users/Alia/AppData/Local/Programs/Python/Python37/python.exe historical_analysis_event.py 2>error.txt {$o0} {$o1} {$y_in_money}",$out,$ret);
$his_analy = explode(" ",$out[0]);
$his_analy_fmoney = explode(" ",$out[1]);
$his_analy_inmoney = explode(" ",$out[2]);
    ...
    <div class="container">
      ...
      <div class="row">
                            ...
                            <div class="col-lg-10">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title">投資金流模擬<?php  //print_r($his_reward); ?></h4>
      ...
      <div class="col-lg-1">
                            ...
                            <div class="col-lg-10">
                                <div class="card alert">
                                    ...
                                    // echo(round($rrr,5)."%");
                                    ?>
                                    <div><h6>過去<?php  echo( (string)$_SESSION['ymdnum'] . (string)$_SESSION['ymd']); ?>的歷史回測結果，
                                      ...
                                      <div class="panel panel-default">
                                          ...
                                          <div id="collapseTwo" class="panel-collapse collapse in">
                                              ...
                                              <table class="table">
                                                ...
                                                <tbody>
                                                    <tr> <td>國際油價暴跌</td> <td>2014/6/20~2016/2/11</td> <td><?php echo($his_event[0]) ?></td>  </tr>
                                                    <tr> <td>Fed啟動升息循環</td> <td>2015/12/17~2018/12/19</td> <td><?php echo($his_event[1]) ?></td>   </tr>
                                                    <tr> <td>英國脫歐</td> <td>2016/6/23~2020/8/5(now)</td> <td><?php echo($his_event[2]) ?></td>   </tr>
                                                    <tr> <td>中美貿易戰</td> <td>2018/3/22~2020/8/5(now)</td> <td><?php echo($his_event[3]) ?></td>   </tr>
